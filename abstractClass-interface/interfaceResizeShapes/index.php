...
for($i=0 ; $i<3 ; $i++){
    ...
    $shape[$i]->resize($rate);
    echo "<br> Diện tích ".$shape[$i]->name." sau khi resize bằng ".$shape[$i]->calculateArea().'<br>';
    echo "<br> Chu vi ".$shape[$i]->name." sau khi resize bằng ".$shape[$i]->calculatePerimeter().'<br>';
}